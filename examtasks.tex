...
\title{Exam tasks (dec, jan, mar, oct)}
\date{}
\begin{document}
\maketitle

\section*{Часть 1. Условия (декабрь, январь, март, октябрь)}

\subsection*{Множества — Числовые множества}
\begin{enumerate}
\item \textbf{Октябрь, № 1} \par \smallskip
$\displaystyle \text{Which of the following statements is correct?}$
\begin{enumerate}
\item $\displaystyle \text{A. -2 }\in\text{  ℕ}$
\item $\displaystyle \text{B. }\pi\text{  }\in\text{  ℚ}$
\item $\displaystyle \text{C. 3/2 }\in\text{  ℤ}$
\item $\displaystyle \text{D. }\sqrt{3}\text{ }\in\text{  R}$
\end{enumerate}
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 2} \par \smallskip
$\displaystyle \text{If sets A = }\{\text{1,2,3,4}\}\text{, B = }\{\text{3,4,5,6}\}\text{, which operation is correct?}$
\begin{enumerate}
\item $\displaystyle \text{A. A }\cup\text{  B = }\{\text{3,4}\}$
\item $\displaystyle \text{B. A }\cap\text{  B = }\{\text{5,6}\}$
\item $\displaystyle \text{C. A }\cap\text{  B = }\{\text{1,2,5,6}\}$
\item $\displaystyle \text{D. A }\cup\text{  B = }\{\text{1,2,3,4,5,6}\}$
\end{enumerate}
...
\item $\displaystyle \text{D. }\OPENNEGINF\text{ , 1)}$
\end{enumerate}
\item \textbf{Октябрь, № 4} \par \smallskip
$\displaystyle \text{The domain of the function f(x) = }\ln\text{ x + }\sqrt{1 - x}\text{ is}$
\begin{enumerate}
\item $\displaystyle \text{A. }\{\text{x }\mid\text{ 0 < x }\leq\text{  1}\}$
\item $\displaystyle \text{B. }\{\text{x }\mid\text{ x > 0}\}$
\item $\displaystyle \text{C. }\{\text{x }\mid\text{ x }\leq\text{  1}\}$
...
\begin{enumerate}
\item \textbf{Октябрь, № 8} \par \smallskip
$\displaystyle \text{Which point lies in the third quadrant?}$
\begin{enumerate}
...
\item $\displaystyle \text{D. (-1,2)}$
\end{enumerate}
\item \textbf{Октябрь, № 5} \par \smallskip
$\displaystyle \text{If point M(a + 3, a + 1) lies on the x-axis, then its coordinates are}$
\begin{enumerate}
\item $\displaystyle \text{A. (0, -4)}$
\item $\displaystyle \text{B. (0, -2)}$
\item $\displaystyle \text{C. (2, 0)}$
\item $\displaystyle \text{D. (4, 0)}$
\end{enumerate}
\end{enumerate}

\subsection*{Функции — Обратные функции}
\begin{enumerate}
\item \textbf{Октябрь, № 9} \par \smallskip
$\displaystyle \text{Given function y = 1 - x}^{3}\text{, its inverse function is}$
\begin{enumerate}
\item $\displaystyle \text{A. y = ³}\sqrt{1 - x}$
\item $\displaystyle \text{B. y = ³}\sqrt{x - 1}$
\item $\displaystyle \text{C. y = ³}\sqrt{1 + x}$
\item $\displaystyle \text{D. y = }\sqrt{1 - x}$
\end{enumerate}
...
\item $\displaystyle \text{D. }\OPENNEGINF\text{ , 1]}$
\end{enumerate}
\item \textbf{Октябрь, № 11} \par \smallskip
$\displaystyle \text{The solution set of the fractional inequality (2x - 4)/(x - 1) }\leq\text{  0 is}$
\begin{enumerate}
\item $\displaystyle \text{A. }\{\text{x }\mid\text{ 1 < x }\leq\text{  2}\}$
\item $\displaystyle \text{B. }\{\text{x }\mid\text{ 1 }\leq\text{  x < 2}\}$
\item $\displaystyle \text{C. }\{\text{x }\mid\text{ 1 }\leq\text{  x }\leq\text{  2}\}$
\item $\displaystyle \text{D. }\{\text{x }\mid\text{ x < 1  x > 2}\}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 12} \par \smallskip
$\displaystyle \text{Given a = }\sqrt{2}\text{ + 1, b = }\sqrt{2}\text{ - 1, the geometric mean of a and b is}$
\begin{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 6} \par \smallskip
$\displaystyle \text{Given angle }\alpha\text{  = 5}\pi\text{ /6, which conclusion is correct?}$
\begin{enumerate}
\item $\displaystyle \text{A. }\sin\text{ }\alpha\text{  = 1/2}$
\item $\displaystyle \text{B. }\sin\text{ }\alpha\text{  = -1/2}$
\item $\displaystyle \text{C. }\sin\text{ }\alpha\text{  = -}\sqrt{3}\text{/2}$
\item $\displaystyle \text{D. }\sin\text{ }\alpha\text{  = }\sqrt{3}\text{/2}$
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Октябрь, № 15} \par \smallskip
$\displaystyle \text{Given that the terminal side of angle }\alpha\text{  passes through point M(2, 4), then }\tan\text{ }\alpha\text{  =}$
\begin{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 7} \par \smallskip
$\displaystyle \text{Which of the following functions is even?}$
\begin{enumerate}
\item $\displaystyle \text{A. f(x) = 2x}^{2}\text{ + }\cos\text{ x}$
\item $\displaystyle \text{B. f(x) = x + 3x}^{2}$
\item $\displaystyle \text{C. f(x) = √x}$
\item $\displaystyle \text{D. f(x) = x}^{2}\text{ - }\sin\text{ x}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 10} \par \smallskip
$\displaystyle \text{Which function is decreasing on (0, }\PLUSINFTAIL\text{ )?}$
\begin{enumerate}
\item $\displaystyle \text{A. y = 3x}$
\item $\displaystyle \text{B. y = x}^{2}$
\item $\displaystyle \text{C. y = x}^{3}$
\item $\displaystyle \text{D. y = 1/x}$
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Октябрь, № 22} \par \smallskip
$\displaystyle \text{If a, b, c are rational numbers and a > b > c, which inequality is correct?}$
\begin{enumerate}
\item $\displaystyle \text{A. a/c > b/c}$
\item $\displaystyle \text{B. a + b > b + c}$
\item $\displaystyle \text{C. a - b > b - c}$
\item $\displaystyle \text{D. ab > bc}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 16} \par \smallskip
$\displaystyle \text{If \{a}_{n}\text{\} is an arithmetic sequence with a}_{1}\text{ = 1, a}_{2}\text{ = 3, then a}_{5}\text{ =}$
\begin{enumerate}
\item $\displaystyle \text{A. 9}$
\item $\displaystyle \text{B. 11}$
\item $\displaystyle \text{C. 5}$
\item $\displaystyle \text{D. 7}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 21} \par \smallskip
$\displaystyle \text{If sequence \{a}_{n}\text{\} is 1/2, -1/4, 1/8, }\ldots\text{ , then the general term a}_{n}\text{ =}$
\begin{enumerate}
\item $\displaystyle \text{A. (-1)}^{n}\text{ }\times\text{  1/2}^{n}$
\item $\displaystyle \text{B. 1/2}^{n}$
\item $\displaystyle \text{C. (-1)}^{n}\text{⁻¹ }\times\text{  1/2}^{n}$
\item $\displaystyle \text{D. 1/2}^{n}\text{⁻¹}$
\end{enumerate}
\item \textbf{Октябрь, № 40} \par \smallskip
$\displaystyle \text{If in sequence \{a}_{n}\text{\}, a}_{1}\text{ = 1, a}_{2}\text{ = 3, and a}_{n}\text{₊₂ = a}_{n}\text{₊₁ + a}_{n}\text{ (n = 1, 2, }\ldots\text{ ), then a}_{5}\text{ =}$
\begin{enumerate}
\item $\displaystyle \text{A. 7}$
\item $\displaystyle \text{B. -7}$
\item $\displaystyle \text{C. 11}$
\item $\displaystyle \text{D. -11}$
\end{enumerate}
...
\item $\displaystyle \text{D. (x + 3)}^{2}\text{ + (y - 2)}^{2}\text{ = 16}$
\end{enumerate}
\item \textbf{Октябрь, № 19} \par \smallskip
$\displaystyle \text{If a circle passes through point A(2, 2) and has center (2, 0), its equation is}$
\begin{enumerate}
\item $\displaystyle \text{A. (x - 2)}^{2}\text{ + y}^{2}\text{ = 2}$
\item $\displaystyle \text{B. x}^{2}\text{ + (y - 2)}^{2}\text{ = 2}$
\item $\displaystyle \text{C. (x - 2)}^{2}\text{ + (y - 2)}^{2}\text{ = 4}$
\item $\displaystyle \text{D. (x - 2)}^{2}\text{ + y}^{2}\text{ = 4}$
\end{enumerate}
...
\item $\displaystyle \text{D. 1}$
\end{enumerate}
\item \textbf{Октябрь, № 33} \par \smallskip
$\displaystyle \text{If a circle has center (-3, 2) and radius 4, its equation is}$
\begin{enumerate}
\item $\displaystyle \text{A. (x - 3)}^{2}\text{ + (y + 2)}^{2}\text{ = 4}$
\item $\displaystyle \text{B. (x - 3)}^{2}\text{ + (y + 2)}^{2}\text{ = 16}$
\item $\displaystyle \text{C. (x + 3)}^{2}\text{ + (y - 2)}^{2}\text{ = 4}$
\item $\displaystyle \text{D. (x + 3)}^{2}\text{ + (y - 2)}^{2}\text{ = 16}$
\end{enumerate}
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Октябрь, № 17} \par \smallskip
$\displaystyle \text{Given points A(-1,2), B(3,-1), the distance between them |AB| =}$
\begin{enumerate}
\item $\displaystyle \text{A. }\sqrt{5}$
\item $\displaystyle \text{B. 25}$
\item $\displaystyle \text{C. 5}$
\item $\displaystyle \text{D. 4}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 31} \par \smallskip
$\displaystyle \text{The distance from point P(1, 3) to point Q(3, -1) is}$
\begin{enumerate}
\item $\displaystyle \text{A. }\sqrt{5}$
\item $\displaystyle \text{B. 2}\sqrt{5}$
\item $\displaystyle \text{C. }\sqrt{17}$
\item $\displaystyle \text{D. 2}$
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Октябрь, № 24} \par \smallskip
$\displaystyle \text{If }\cos\text{ }\alpha\text{  = 1/3, then }\cos\text{ 2}\alpha\text{  =}$
\begin{enumerate}
\item $\displaystyle \text{A. 4}\sqrt{2}$
\item $\displaystyle \text{B. 7/9}$
\item $\displaystyle \text{C. 4}\sqrt{2}\text{/9}$
\item $\displaystyle \text{D. -7/9}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 27} \par \smallskip
$\displaystyle \text{Which inequality is correct?}$
\begin{enumerate}
\item $\displaystyle \text{A. 2.1}^{3}\text{ > 1.2}^{3}$
\item $\displaystyle \text{B. 2.1⁻² > 1.2⁻²}$
\item $\displaystyle \text{C. 0.75⁻⁰}\cdot\text{ ² > 0.75⁻⁰}\cdot\text{ ⁴}$
\item $\displaystyle \text{D. 3}^{2}\cdot\text{ ²}^{5}\text{ > 3}^{3}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 26} \par \smallskip
$\displaystyle \text{The coordinates of the foci of the hyperbola x}^{2}\text{/7 - y}^{2}\text{/9 = 1 are}$
\begin{enumerate}
\item $\displaystyle \text{A. (0, 4)}$
\item $\displaystyle \text{B. (4, 0)}$
\item $\displaystyle \text{C. (0, ±4)}$
\item $\displaystyle \text{D. (±4, 0)}$
\end{enumerate}
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 20} \par \smallskip
$\displaystyle \text{If }\tan\text{ }\alpha\text{  = 2, then (3 }\sin\text{ }\alpha\text{  + 2 }\cos\text{ }\alpha\text{ )/(4 }\sin\text{ }\alpha\text{  - 3 }\cos\text{ }\alpha\text{ ) =}$
\begin{enumerate}
\item $\displaystyle \text{A. 8/5}$
\item $\displaystyle \text{B. 3/5}$
\item $\displaystyle \text{C. -8/5}$
\item $\displaystyle \text{D. 5/3}$
\end{enumerate}
\item \textbf{Октябрь, № 36} \par \smallskip
$\displaystyle \text{Given }\sin\text{ }\alpha\text{  = 3/5, and }\alpha\text{  }\in\text{  (0, }\pi\text{ /2), then (2 }\sin\text{ 2}\alpha\text{ )/(1 + }\cos\text{ 2}\alpha\text{ ) - }\tan\text{ }\alpha\text{  =}$
\begin{enumerate}
\item $\displaystyle \text{A. 3/5}$
\item $\displaystyle \text{B. 4/3}$
\item $\displaystyle \text{C. 3/4}$
\item $\displaystyle \text{D. 4/5}$
\end{enumerate}
...
\item $\displaystyle \text{D. 120^}\circ\text{ }$
\end{enumerate}
\item \textbf{Октябрь, № 18} \par \smallskip
$\displaystyle \text{The equation of the line passing through point M(-2,3) with slope k = 2 is}$
\begin{enumerate}
\item $\displaystyle \text{A. y = x + 7}$
\item $\displaystyle \text{B. y = 2x - 1}$
\item $\displaystyle \text{C. y = 2x + 7}$
\item $\displaystyle \text{D. y = x + 5}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 32} \par \smallskip
$\displaystyle \text{Given lines l}_{1}\text{: ax + 2y - 1 = 0 and l}_{2}\text{: x + (a + 1)y + 4 = 0 are parallel, then a =}$
\begin{enumerate}
\item $\displaystyle \text{A. 1}$
\item $\displaystyle \text{B. -2  (and)  1}$
\item $\displaystyle \text{C. -2}$
\item $\displaystyle \text{D. 2   (and) -1}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 14} \par \smallskip
$\displaystyle \text{The slope of the line passing through points A(-1, 1), B(2, 3) is}$
\begin{enumerate}
\item $\displaystyle \text{A. 3/2}$
\item $\displaystyle \text{B. -3/2}$
\item $\displaystyle \text{C. 2/3}$
\item $\displaystyle \text{D. -2/3}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 25} \par \smallskip
$\displaystyle \text{The intersection point of lines 3x + 2y + 4 = 0 and x - y + 3 = 0 is}$
\begin{enumerate}
\item $\displaystyle \text{A. (1, -2)}$
\item $\displaystyle \text{B. (2, 5)}$
\item $\displaystyle \text{C. (-2, 1)}$
\item $\displaystyle \text{D. (5, 2)}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 45} \par \smallskip
$\displaystyle \text{If line l is perpendicular to line l}_{1}\text{: x + 2y + 4 = 0, and passes through the intersection of lines l}_{2}\text{: x + y + 1 = 0 and l}_{3}\text{: 2x + y - 1 = 0, then the equation of l is}$
\begin{enumerate}
\item $\displaystyle \text{A. 2x - y - 7 = 0}$
\item $\displaystyle \text{B. x + 2y - 3 = 0}$
...
\begin{enumerate}
\item \textbf{Октябрь, № 23} \par \smallskip
$\displaystyle \text{Regarding power functions y = x}^{3}\text{ and y = x}^{1}\text{/³, which conclusion is correct?}$
\begin{enumerate}
\item $\displaystyle \text{A.  x  / Graphs are symmetric with respect to the x‑axis}$
\item $\displaystyle \text{B.  y = x  / Graphs are symmetric with respect to the line y = x}$
\item $\displaystyle \text{C.  y  / Graphs are symmetric with respect to the y‑axis}$
\item $\displaystyle \text{D.  / Graphs are symmetric with respect the origin}$
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Октябрь, № 29} \par \smallskip
$\displaystyle \text{Regarding the cosine function y = }\cos\text{ x, which conclusion is correct?}$
\begin{enumerate}
\item $\displaystyle \text{A.  / It is a periodic function}$
\item $\displaystyle \text{B.   / It is a decreasing function}$
\item $\displaystyle \text{C.   / It is an increasing function}$
\item $\displaystyle \text{D.  / It is an odd function}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 38} \par \smallskip
$\displaystyle \text{Regarding the tangent function y = }\tan\text{ x, which statement is incorrect?}$
\begin{enumerate}
\item $\displaystyle \text{A.  R / The range is R}$
\item $\displaystyle \text{B.  / It is an odd function}$
\item $\displaystyle \text{C.  }\pi\text{  /  It is a periodic, and its smallest positive period is }\pi\text{ }$
\item $\displaystyle \text{D.  /The domain is }\{\text{x }\mid\text{ x }\neq\text{  k}\pi\text{ , k }\in\text{  Z}\}$
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Октябрь, № 34} \par \smallskip
$\displaystyle \text{Given }\cos\text{ }\alpha\text{  = -4/5, and }\alpha\text{  }\in\text{  (}\pi\text{ /2, }\pi\text{ ), then sin(}\alpha\text{  + }\pi\text{ /4) =}$
\begin{enumerate}
\item $\displaystyle \text{A. -7}\sqrt{2}\text{/10}$
\item $\displaystyle \text{B. }\sqrt{2}\text{/10}$
\item $\displaystyle \text{C. -}\sqrt{2}\text{/10}$
\item $\displaystyle \text{D. 7}\sqrt{2}\text{/10}$
\end{enumerate}
...
\item $\displaystyle \text{D. }\{\text{x }\mid\text{ x }\geq\text{  1}\}$
\end{enumerate}
\item \textbf{Октябрь, № 28} \par \smallskip
\textit{(no English statement.)}
\begin{enumerate}
\item $\displaystyle \text{A. 3/2}$
\item $\displaystyle \text{B. -3/2}$
...
\item $\displaystyle \text{D. 5}$
\end{enumerate}
\item \textbf{Октябрь, № 42} \par \smallskip
$\displaystyle \text{Given a = }\ln\text{ 3, b = log}_{0.3}\text{ 2, c = log\_3 2, then the order of a, b, c is}$
\begin{enumerate}
\item $\displaystyle \text{A. a < c < b}$
\item $\displaystyle \text{B. c < a < b}$
\item $\displaystyle \text{C. a < b < c}$
\item $\displaystyle \text{D. b < c < a}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 37} \par \smallskip
$\displaystyle \text{Which of the following equations is correct?}$
\begin{enumerate}
\item $\displaystyle \text{A. sin(}\alpha\text{  + 4}\pi\text{ ) = }\cos\text{ }\alpha\text{ }$
\item $\displaystyle \text{B. sin(}\alpha\text{  + 3}\pi\text{ ) = }\sin\text{ }\alpha\text{ }$
\item $\displaystyle \text{C. cos(}\alpha\text{  + 3}\pi\text{ /2) = }\sin\text{ }\alpha\text{ }$
\item $\displaystyle \text{D. cos(}\alpha\text{  + }\pi\text{ /2) = }\sin\text{ }\alpha\text{ }$
\end{enumerate}
...
\item $\displaystyle \text{D. y = √x}^{2}$
\end{enumerate}
\item \textbf{Октябрь, № 35} \par \smallskip
$\displaystyle \text{Which pair of functions are identical?}$
\begin{enumerate}
\item $\displaystyle \text{A. y = }\ln\text{ x}^{2}\text{  y = 2 }\ln\text{ x}$
\item $\displaystyle \text{B. y = |x - 1|  y = }\sqrt{(x - 1}^{2}\text{)}$
\item $\displaystyle \text{C. y = x}^{2}\text{ + 1  y = (x}^{4}\text{ - 1)/(x}^{2}\text{ - 1)}$
\item $\displaystyle \text{D. y = }\ln\text{ x(x - 1)  y = }\ln\text{ x + ln(x - 1)}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 30} \par \smallskip
$\displaystyle \text{The standard equation of the parabola with vertex at origin and focus F(3/2, 0) is}$
\begin{enumerate}
\item $\displaystyle \text{A. y}^{2}\text{ = (3/2)x}$
\item $\displaystyle \text{B. y}^{2}\text{ = 3x}$
\item $\displaystyle \text{C. y}^{2}\text{ = 6x}$
\item $\displaystyle \text{D. y}^{2}\text{ = -6x}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 41} \par \smallskip
$\displaystyle \text{The directrix of the parabola y}^{2}\text{ = -x is}$
\begin{enumerate}
\item $\displaystyle \text{A. x = 1/4}$
\item $\displaystyle \text{B. x = -1/2}$
\item $\displaystyle \text{C. x = -1/4}$
...
\item $\displaystyle \text{D. 1/2}$
\end{enumerate}
\item \textbf{Октябрь, № 39} \par \smallskip
$\displaystyle \text{Given }\cos\text{ }\alpha\text{  = -1/2, }\alpha\text{  }\in\text{  (}\pi\text{ /2, }\pi\text{ ), then sin(}\alpha\text{ /2) =}$
\begin{enumerate}
\item $\displaystyle \text{A. -1/2}$
\item $\displaystyle \text{B. -}\sqrt{3}\text{/2}$
\item $\displaystyle \text{C. 1/2}$
\item $\displaystyle \text{D. }\sqrt{3}\text{/2}$
\end{enumerate}
...
\item $\displaystyle \text{D. 6}$
\end{enumerate}
\item \textbf{Октябрь, № 43} \par \smallskip
$\displaystyle \text{The center of an ellipse is at origin, its major axis is twice the minor axis, and it passes through point P(-2, 0), then its equation is}$
\begin{enumerate}
\item $\displaystyle \text{A. x}^{2}\text{/16 + y}^{2}\text{/4 = 1   (and) x}^{2}\text{/4 + y}^{2}\text{ = 1}$
\item $\displaystyle \text{B. x}^{2}\text{ + y}^{2}\text{/4 = 1}$
\item $\displaystyle \text{C. x}^{2}\text{/4 + y}^{2}\text{/16 = 1  (and) x}^{2}\text{/4 + y}^{2}\text{ = 1}$
\item $\displaystyle \text{D. x}^{2}\text{/16 + y}^{2}\text{/4 = 1}$
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Октябрь, № 44} \par \smallskip
$\displaystyle \text{Given vectors a = (-1, 2), b = (3, -1), then 3a - b =}$
\begin{enumerate}
\item $\displaystyle \text{A. (0, -3)}$
\item $\displaystyle \text{B. (0, 5)}$
\item $\displaystyle \text{C. (-6, 5)}$
\item $\displaystyle \text{D. (-6, 7)}$
\end{enumerate}
...
\end{enumerate}
\item \textbf{Октябрь, № 47} \par \smallskip
$\displaystyle \text{For geometric sequence \{a}_{n}\text{\} with sum of first n terms S}_{n}\text{, if S}_{2}\text{ = 4, S}_{4}\text{ = 20, then S}_{8}\text{ =}$
\begin{enumerate}
\item $\displaystyle \text{A. 160}$
\item $\displaystyle \text{B. 340}$
\item $\displaystyle \text{C. 180}$
\item $\displaystyle \text{D. 210}$
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Октябрь, № 46} \par \smallskip
$\displaystyle \text{Given complex number |z| = 1, then the maximum value of |2z + 1| is}$
\begin{enumerate}
\item $\displaystyle \text{A. 2}$
\item $\displaystyle \text{B. 1}$
\item $\displaystyle \text{C. 5/2}$
